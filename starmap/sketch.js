...
async function captureCanvasAndSend() {
    ...
    let promptText = "A glowing celestial animal constellation, the stars and nebula lines strictly follow the silhouette of a hand gesture, cosmic art style, high detail.";    
